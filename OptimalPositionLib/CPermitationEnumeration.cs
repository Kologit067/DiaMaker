...
namespace OptimalPositionLib
{
    ...
    //--------------------------------------------------------------------------------------
    public class CPermitationEnumeration : CPermitationBase
    {
        ...
        //--------------------------------------------------------------------------------------
        public CPermitationEnumeration(int pSize, int pNumberOfPlace) : base(pSize, pNumberOfPlace)
        {
        }
        //--------------------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------------------
    public class CPermitationEmptyLastEnumeration : CPermitationEmptyLast
    {
        private List<int[]> fResultSet = new List<int[]>();
        private List<string> fResultStringList = new List<string>();
        private HashSet<string> fResultStringSet = new HashSet<string>();
        //--------------------------------------------------------------------------------------
        public CPermitationEmptyLastEnumeration(int pSize, int pNumberOfPlace)
    ...
    public class CPermitationBaseEmptyLastEnumeration : CPermitationBaseEmptyLast
    {
        ...
        private HashSet<string> fResultStringSet = new HashSet<string>();
        //--------------------------------------------------------------------------------------
        public CPermitationBaseEmptyLastEnumeration(int pSize, int pNumberOfPlace)
            : base(pSize, pNumberOfPlace)
        {
        }
        //--------------------------------------------------------------------------------------
